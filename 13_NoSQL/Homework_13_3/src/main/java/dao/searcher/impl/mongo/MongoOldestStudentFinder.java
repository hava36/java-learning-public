...
@AllArgsConstructor
public class MongoOldestStudentFinder implements SearchHandler<Student> {
  ...
  public List<Student> find() {
    ...
    MongoCursor<Document> iterator = collection.find().sort(Sorts.orderBy(Sorts.descending("age")))
        .limit(1).iterator();
